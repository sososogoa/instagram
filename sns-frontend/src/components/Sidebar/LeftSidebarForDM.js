...
const LeftSidebarForDM = ({ setShowNotifications }) => {
  ...
  return (
    <div
      className={"fixed top-0 left-0 h-full bg-white border-r border-gray-300 transition-all duration-300 ease-in-out w-16"}
    >
      <div className="p-4">
...
export default LeftSidebarForDM;
